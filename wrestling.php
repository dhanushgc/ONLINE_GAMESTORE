...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="wrestling.php">WRESTLING</a></li>		
	</ul>
</div>
...
<?php
$results = $mysqli->query("SELECT g_name, g_code, g_img, price, DistributorID FROM wrestling WHERE price='FREE' ORDER BY g_id ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<div class="box">
	<li class="product">
	<form method="post" action="cartw.php">	
