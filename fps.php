...
<html>
<head>
	<title>FIRST-PERSON SHOOTER-GAMES</title>
...
<div id="navbar">
	<ul>
		...
		<li><a class="active"  href="fps.php">FIRST-PERSON SHOOTER-GAMES</a></li>
...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
	...
	echo '<thead style="color:white;"><th>NAME</th><th>DISTRIBUTER</th><th>REMOVE</th></tr></thead>';
	echo '<tbody>';
...
<?php
$results = $mysqli->query("SELECT g_name, g_code, g_img, price, DistributorID FROM fps WHERE price='FREE' ORDER BY g_id ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<div class="box">
	<li class="product">
	<form method="post" action="cartfps.php">	
...
<footer class="container">
	<div class="row">	
		<p style="color:black;" class="col-sm-6">
